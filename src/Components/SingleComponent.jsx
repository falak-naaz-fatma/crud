...
const SingleComponent = () => {
    ...
    return (
        ...
        {/* {console.log(item.image)}
            ...
            <div className="w-full m-8 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

                <a href="#">
                    <img className="p-8 rounded-t-lg object-cover" src={item.image} alt="product image" />
                </a>
